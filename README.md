...
* particleSpeed = How fast the particles can travel (Speed Limit), I'd keep below 20
* numParticles = Number of particles rendered. When I was testing, the most I could get to run smoothly was 25,000
* particleSize = Size of each particle (pixels)
* particleColor = A string passed to the particle constructor that determines its color when displayed as an ellipsoid
